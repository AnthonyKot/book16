...
g "git -C repos/linux show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' 4ceb5db9757aaeadcf8fbbf97d76bd42aa4df0d6" "git -C repos/linux show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' 4ceb5db9757aaeadcf8fbbf97d76bd42aa4df0d6" 40
echo "## R2 — 2005-08-03: the s390/copy_one_pte objection and replacement protocol"
g "git -C repos/linux show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' f33ea7f404e592e4563b12101b7a4d17da6558d7" "git -C repos/linux show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' f33ea7f404e592e4563b12101b7a4d17da6558d7" 48
...
g "git -C repos/linux show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' 19be0eaffa3ac7d8eb6784ad9bdbc7d67ed8e619" "git -C repos/linux show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' 19be0eaffa3ac7d8eb6784ad9bdbc7d67ed8e619" 70
...
g "git -C repos/linux show -s --format='%H%nAuthorDate: %aI%nAuthor: %an <%ae>%nSubject: %s%n%n%b' 8310d48b125d19fcd9521d83b8293e63eb1646aa | sed -n '1,17p;57,77p'" "git -C repos/linux show -s --format='%H%nAuthorDate: %aI%nAuthor: %an <%ae>%nSubject: %s%n%n%b' 8310d48b125d19fcd9521d83b8293e63eb1646aa | sed -n '1,17p;57,77p'" 40
echo "## R8 — 2020 aftermath: Linus documents that COW can break either way"
g "git -C repos/linux show -s --format='%H%nAuthorDate: %aI%nAuthor: %an <%ae>%nSubject: %s%n%n%b' 17839856fd588f4ab6b789f482ed3ffd7c403e1f | sed -n '1,21p;31,55p'" "git -C repos/linux show -s --format='%H%nAuthorDate: %aI%nAuthor: %an <%ae>%nSubject: %s%n%n%b' 17839856fd588f4ab6b789f482ed3ffd7c403e1f | sed -n '1,21p;31,55p'" 48
echo "## R9 — 2022 aftermath: an explicit Dirty COW/CVE mention and removal of FOLL_COW"
g "git -C repos/linux show -s --format='%H%nAuthorDate: %aI%nAuthor: %an <%ae>%nSubject: %s%n%n%b' 5535be3099717646781ce1540cf725965d680e7b | sed -n '1,20p;50,67p;83p'" "git -C repos/linux show -s --format='%H%nAuthorDate: %aI%nAuthor: %an <%ae>%nSubject: %s%n%n%b' 5535be3099717646781ce1540cf725965d680e7b | sed -n '1,20p;50,67p;83p'" 42
echo "## R10 — Bitcoin twin: the entire 2018 repair is false to true"
g "git -C repos/bitcoin show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' b8f801964f59586508ea8da6cf3decd76bc0e571" "git -C repos/bitcoin show --stat --format='commit %H%nAuthor: %an <%ae>%nAuthorDate: %aI%nCommitter: %cn <%ce>%nCommitDate: %cI%n%n%B' b8f801964f59586508ea8da6cf3decd76bc0e571" 20
...
g "git -C repos/bitcoin show -s --format='commit %H%nAuthorDate: %aI%nAuthor: %an <%ae>%n%n%B' 38bfca6bb2ad68719415e9c54a981441052da072 | sed -n '1,18p'" "git -C repos/bitcoin show -s --format='commit %H%nAuthorDate: %aI%nAuthor: %an <%ae>%n%n%B' 38bfca6bb2ad68719415e9c54a981441052da072 | sed -n '1,18p'" 20
